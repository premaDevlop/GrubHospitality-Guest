...
export default function BillSummaryCard({ amount = 1500 }) {
  return (
    ...
    <div className="min-h-[280px] min-w-[390px] relative flex flex-col select-none shrink-0 ">
      ...
      <div className="relative z-10 w-full px-6 pt-5 pb-8 mt-8  flex flex-col gap-3">
